export const defaultExercises = [
  ...
  { id: 'e4', name: '蝴蝶机夹胸 / 绳索夹胸', target: '胸', sets: 2, reps: '12-15', rest: 45, imageUrl: '', notes: '作用：胸部挤压收尾，让胸部更有泵感和线条。\n细节：手臂微屈固定角度，想象用手肘去抱树，顶峰收缩停顿1秒。' },
  ...
  { id: 'e31', name: '绳索弯举 / 集中弯举', target: '二头', sets: 2, reps: '10-12', rest: 45, imageUrl: '', notes: '作用：补泵感和手臂线条。\n细节：全程控制重量，顶峰极致挤压。' },
];
...
export const defaultRoutines = [
  ...
  { dayOfWeek: 6, name: "背 + 手臂 + 腹", exerciseIds: ['e27', 'e9', 'e28', 'e29', 'e30', 'e31', 'e20'] },
